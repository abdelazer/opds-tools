...
class TestOpds(object):
    ...
    def test_output_has_crawlable(self):
        ...
        crawlable_links = len(xml.xpath('/atom:feed/atom:link[@rel="http://opds-spec.org/crawlable"]', namespaces=NSS))
        expected = 1
    ...
    def test_output_has_crawlable(self):
        ...
        crawlable_xml = etree.parse(catalog_fn)
        entries = len(xml.xpath('/atom:feed/atom:entry', namespaces=NSS))
        expected = 3
    ...
    def _write_simple_csv(self, csv_fn):
        ...
        row3 = ('', 'R\x8edacteurix, une Histoire', 'Liz\x87 D\x89ly', '1899', 'Troispresse', '9.99', 'EUR', 'http://threepress.org/examples/opds/downloads/3.epub', 'http://threepress.org/examples/opds/downloads/3.pdf', 'http://threepress.org/examples/opds/downloads/3.mobi', 'http://threepress.org/examples/opds/covers/3.thumb.png', 'fr', 'http://threepress.org/examples/opds/covers/3.thumb.png', '', 'http://threepress.org/examples/opds/identifiers/3', '', '')
